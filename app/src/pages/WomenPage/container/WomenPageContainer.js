...
import {addQuantity, addSelectedProduct} from "../../../redux/reducers/popup/popupReducer";
...
export default connect(mapStateToProps,{getCategories, getCategory, getProductCategory,addSelectedProduct,addQuantity})(WomenPageContainer);